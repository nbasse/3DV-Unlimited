...
#define STRING_CONFIG_H_AUTHOR "ZU by NB & LB" // Who made the changes.
#endif
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.0,80.0,1360,369}  // default steps per unit for ultimaker2.1 JarJar
...
#define FILAMANT_BOWDEN_LENGTH        300
